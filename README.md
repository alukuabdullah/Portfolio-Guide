...
|---|---|---|---|
| 🩺 [NY State Asthma ED Visits Analysis](#) | SQL Server, Power BI | Analysis of 3,870 real emergency department visit records from the NY State Department of Health (2000–2019), covering county burden, age groups, seasonal patterns, and 15-year trends. | Real government dataset — identifies the most-improved counties over a 15-year period and highlights persistent seasonal and demographic patterns in asthma ED visits. |
